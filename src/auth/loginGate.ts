...
const VITRUVIAN_SVG = `
  <svg viewBox="0 0 520 505" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" aria-hidden="true">
    ...
    <path d="M150,170 C133,177 127,194 136,214 C140,226 144,235 216,255 L206,292 C200,305 197,318 214,332 L240,340" stroke-width="1.8"/>
    <path d="M370,170 C387,177 393,194 384,214 C380,226 376,235 304,255 L314,292 C320,305 323,318 306,332 L280,340" stroke-width="1.8"/>
    <path d="M240,340 C236,360 232,383 234,406 C235,424 236,447 236,464 L234,496" stroke-width="1.8"/>
    <path d="M280,340 C284,360 288,383 286,406 C285,424 284,447 284,464 L286,496" stroke-width="1.8"/>
  </svg>
`;
